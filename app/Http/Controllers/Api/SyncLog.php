...
use App\Models\SyncLog as Model;
use App\Http\Controllers\ApiController;
use App\Http\Controllers\Transformers\SyncLog\SyncLogTransformer;

class SyncLog extends ApiController
{

	protected $transformer, $search, $page, $rows, $offset;

	function __construct(SyncLogTransformer $transformer)
	{
